export function changeVideo(name){
    ...
    let videoSrc = document.querySelectorAll('#videoDescription video source');
    ...
    if(name == 'mv'){
        ...
        videoSrc[0].setAttribute('src', './media/OneLastKissMV.webm');
        videoSrc[1].setAttribute('src', './media/OneLastKissMV.mov');
        ...
        videoSrc[0].setAttribute('src', './media/KevinsKitchen.webm');
        videoSrc[1].setAttribute('src', './media/KevinsKitchen.mp4');
        ...
        videoSrc[0].setAttribute('src', './media/Danger.webm');
        videoSrc[1].setAttribute('src', './media/Danger.mov');
        ...
        videoSrc[0].setAttribute('src', './media/HarderFamily.webm');
        videoSrc[1].setAttribute('src', './media/HarderFamily.mp4');
